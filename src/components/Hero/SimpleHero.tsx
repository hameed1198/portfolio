          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-base md:text-lg lg:text-xl text-gray-300 mb-8 leading-relaxed">
                Python Developer with 4 years of experience specializing in Fullstack & backend development, 
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a
                  href="/resume/Mohammad_Hameed_Khan_Resume.pdf"
                  download
                  className="px-8 py-4 bg-gradient-to-r from-green-500 to-teal-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-green-500/25 transition-all duration-300 hover:scale-105 flex items-center space-x-2"
                >
                ...
                <a
                  ...
                  className="px-6 py-4 border-2 border-white/20 text-white font-semibold rounded-full hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 backdrop-blur-sm hover:scale-105 flex items-center space-x-2"
                >
                ...
                <a
                  href="https://github.com/hameed1198"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-4 border-2 border-white/20 text-white font-semibold rounded-full hover:border-gray-400 hover:bg-gray-500/10 transition-all duration-300 backdrop-blur-sm hover:scale-105 flex items-center space-x-2"
                >
